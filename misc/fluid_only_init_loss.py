...
class Pinns:
    ...
    def compute_init_loss(self,input_init):
...
wandb.init(project='Semester Thesis',name = 'FLUID ONLY changed ANSATZ larger sigma with no init vel loss')
...
torch.save(pinn.approximate_solution.state_dict(),
           "../pre_trained_models/fluid_only_changed_ansatz_larger_sigma_addedloss.pth")
